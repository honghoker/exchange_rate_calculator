...
//                CalculateCountryRowView($draggedCountry, $inputString, $dunamuViewModel.standardCountry.currencyCode, $dunamuViewModel.standardCountryBasePrice) // 내가 추가한 국가들 리스트 뷰 (스크롤 뷰로 구현)
                // admob
